...
<aside id="left-sidebar-nav">
  <ul id="slide-out" class="side-nav leftside-navigation">
    <li class="user-details cyan darken-2">
        <div class="row">
            ...
            <div class="col col s8 m8 l8" style="color:#13243D">
      ...
      <ul class="collapsible collapsible-accordion">
        ...
        $consulta="SELECT *
          ...
          foreach($vrolmenu->sql($consulta) as $dmenu)
          {
            ...
            ?>
            <li class="bold"><a style="color:#00423A;" class="collapsible-header waves-effect waves-green <?php if($sw)echo "active"; ?>"><i class="fa fa-<?php echo $dmenu['icon'] ?>"></i> <?php echo $dmenu['nombre'] ?></a>
  ...
  <a href="#" data-activates="slide-out" class="sidebar-collapse btn-floating btn-large waves-effect waves-light white darken-4" style="background: red;">
    <i class="mdi-navigation-menu" style="color: #005D80;"></i>
  </a>
</aside>