...
<head>
    <?php
      $hd_titulo="ASIGNAR HORARIOS DEL CONDUCTOR ";
            ...
            <div class="container">
              <div class="row">
                <div class="col s12 m12 l12" style="background: white; text-align: center; color:#006458; font-size: 25px; border-radius: 5px; border: #CBCBCB 1px solid; font-weight: bold;">
                       ...
                       <?php echo $hd_titulo.' '.$vdeje['nombre'].' '.$vdeje['paterno'].' '.$vdeje['materno'] ?>
              </div>
              </div>
      ...
      <div class="row" >
        <div class="col s12 m12 l12">
          <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                   <a href="../" class="btn waves-effect waves-light darken-4 red"><i class="fa fa-mail-reply-all"></i> </a> 
           </div>
        </div> 
        <div class="col s12 m12 l12">
          <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
              ...
              <div class="row">
                ...
                foreach($diasconfig->mostrarTodo("estado=1") as $dc)
                {
                  ...
                  <div class="col s12 m6 l3">
                      <div class="card">
                          <div class="card-content" style="background:white; color: #006458; font-weight: bold;" >
                              <p class="card-stats-title"><i class="fa fa-calendar-o"></i> 
                                <?php echo strtoupper($dc['nombre']); ?> 
                                 <a href="#modal1" class="btn-jh waves-effect waves-light darken-4 cyan indigo modal-trigger " onclick="cargadia('<?php echo $dc['iddiasconfig'] ?>','<?php echo $dc['nombre'] ?>');"> <i class="fa fa-plus-square-o"></i> Nuevo</a>
                               </p>
                              
                          </div>
                          <div class="card-action darken-2" style="color: #006458;">
                            <div class="row">                            
                             <div class="col s12 m4 l4" style="background: #E7E7E7; color:#006458; font-weight:bold;">INICIO
                            </div>
                            <div class="col s12 m4 l4" style="background: #E7E7E7; color:#006458; font-weight:bold;">FIN
                            </div>
                            <div class="col s12 m4 l4" style="background: #E7E7E7; color:#006458; font-weight:bold;">Opción
                            </div>
                            <?php                            
                              foreach($horario->mostrarTodo("estado=1 and idadmejecutivo=".$idadmejecutivo." and iddiasconfig=".$dc['iddiasconfig']) as $f)
                              {                              
                                ?>
                                <div class="col s12 m4 l4"><?php echo $f['horainicio'] ?>
                                </div>
                                <div class="col s12 m4 l4"><?php echo $f['horafin'] ?>
                                </div>
                                <div class="col s12 m4 l4"><i class="fa fa-times" onclick="borrar('<?php echo $f['idhorario'] ?>');" style="cursor: pointer; color: #9B0000;"> Eliminar</i>
                                </div>
                              <?php                                
                              }
                             ?>
