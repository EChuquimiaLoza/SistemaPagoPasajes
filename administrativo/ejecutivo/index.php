          ...
          <div id="breadcrumbs-wrapper">
            <div class="container">
              ...
              <div class="col s12 m4 l4" style="background: white; text-align: center; color:#1C2637; border-radius: 5px; border: #CBCBCB 1px solid">
                ...
                <div class="col s12" style="background: #297E5F; color: white;">NUEVO USUARIO</div>
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <!-- <td><?php //echo $f['njerarquia'] ?></td> -->
                      ...
                      <td>
                        <a href="editar/ver.php?lblcode=<?php echo $lblcodep ?>" class="btn waves-effect darken-4 cyan"><i class="fa fa-edit (alias)"></i> ACTUALIZAR</a> 
                        <?php 
                          if ($deje['estado']==0) {
                            ?>
