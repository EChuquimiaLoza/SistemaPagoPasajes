                ...
                <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                  ...
                  <div class="col s12 m12 l12">
                    ...
                    <div class="" style="background: white">  
                      <div class="col s12 m12 l12" style="background: white; text-align: center; color:#006458; font-size: 18px; border-radius: 5px; border: #CBCBCB 1px solid; font-weight: bold;">
                           DATOS PERSONA
                        </div>                 
                      <div class="col s12 green-text" style="background: white"> 
                        <div class="col s2"> 
                        ...
                        <div class="col s10"> 
                          ...
                          <div class="input-field col s3">
                            <a class="btn waves-effect waves-light darken-4 green" href="../../../persona/editar/?lblcode=<?php echo $lblcode; ?>", target="_blank"> <i class="mdi-editor-border-color"></i>MODIFICAR </a>
                          </div> 
                        </div> 
                              ...
                              ?>
                                <fieldset class="formulario">
                                 <!-- <div class="titulo"> MODIFICAR DATOS DE USUARIO</div>-->
                                  ...
                                  <div class="input-field col s12">
                                    <button style="width: 100%" id="btnEdit" class="btn darken-4 green"><i class="fa fa-save"></i> GUARDAR CAMBIOS</button>
                                  </div> 
                                </fieldset>
                              <?php
                            }
