          ...
          <div class="container">
            <div class="section">
              ...
              <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                ...
                <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: #1C2637; color: white; text-align: center; font-size: 15px; font-weight: bold;">VEHICULO ASIGNADO
                  </div>       
