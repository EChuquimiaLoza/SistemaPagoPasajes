...
<table width="100%"  align="center">
  <tr>
    ...
    <td width="50%"><br>
      <div class="tituloFactura">PARTE DIARIO DE PRODUCCION-GOLDEN BRIDGE<br>'.strtoupper(obtenerFechaLetra($fechaGen)).'</div>
    </td>
    <td width="20%"><br>
    <table border="1">
      <tr>
...
$pdf->SetFont('helvetica', '', 6);
  ...
  $montoDesc=0;
  $cantTj=0;
  $dDep=$vcontratodet->mostrarTodo("consolidado=2 and anulado=0 and idsede=$idsede and tipopago>1 and fecha='$fechaGen'");
  $tenor="";
  if (count($dDep)>0) {
    $tenor="TOTAL :";
  }
