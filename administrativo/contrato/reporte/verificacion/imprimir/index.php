...
/******************    SEGURIDAD *************/
extract($_GET);
$dsede=$sede->muestra("idsede=$codsede");
//********* SEGURIDAD GET *************/
...
<table width="100%"  align="center">
  <tr>
    ...
    <td><br>
    <div class="titulo">Centro de Capacitación Tecnica <br> GOLDEN BRIDGE</div>
    </td>
    <td><br>
    <table border="1">
      <tr>
...
$i=1;
    foreach($admcontratodelle->mostrarTodo("codigo=3116 and fecha='$fechaGen'") as $f){
        ...
        foreach($admcontratodelle->mostrarTodo("codigo=3113 and anulado=0 and idcontrato=".$f['idcontrato']) as $g){
        ...
        $fult=$admcontratodelle->mostrarUltimo("codigo=3113 and anulado=0 and idcontrato=".$f['idcontrato']);
...
$pdf->SetFont('helvetica', '', 6);
$i=1;
    foreach($admcontratodelle->mostrarTodo("codigo=3123 and fecha='$fechaGen'") as $f){
        $dcont=$admcontrato->muestra($f['idcontrato']);
        $dtit=$vtitular->muestra($dcont['idtitular']);
        $dus=$usuario->muestra($f['usuariocreacion']);
        $deje=$vejecutivo->muestra($dcont['idadmejecutivo']);
