...
<head>
    <?php
      $hd_titulo="Registrar nuevo cliente";
            ...
            <div id="persona" class="col s12 m12 l12  "><!-- blue lighten-4 -->
                ...
                <div class="col s12 m12 l12">
                    <div class="formcontent">  
                      ...
                      <div class="input-field col s12 m12 l8">
                        ...
                        <div class="input-field col s12 m12 l8">
                          <input id="idocupacion" name="idocupacion" type="text" value="" class="validate">
                ...
                <div class="divider">   </div>
                      ...
                      <div class="input-field col s12 m12 l12" align="right">
                        <a href="../" class="btn-jh waves-effect waves-light red"><i class="fa fa-mail-reply-all"></i> Volver</a>
