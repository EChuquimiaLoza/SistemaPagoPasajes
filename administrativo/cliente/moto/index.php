      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div id="breadcrumbs-wrapper">
            <div class="container">
              <div class="row">
                <div class="col s12 m12 l12" style="background: white; text-align: center; color:#1C2637; font-size: 25px; border-radius: 5px; border: #CBCBCB 1px solid; font-weight: bold;">
                <?php echo $hd_titulo; ?>
              </div>
              </div>
        ...
        <div class="col s12 m8 l8">
                   ...
                   <input id="idadmejecutivo" name="idadmejecutivo" value="<?php echo $idadmejecutivo ?>" type="hidden">
                       <div class="input-field col s12 m6 l6">
                          ...
                          <select id="idcategoria" name="idcategoria">
                            ...
                            <?php
                              foreach($categoria->mostrarTodo("estado=1 and nombre='MOTO'") as $f)
                              {
                                ?>
                        ...
                        <a href="../" class="btn-jh waves-effect waves-light darken-4 red"><i class="fa fa-mail-reply-all"></i> Volver</a>
                          <a id="btnSave" class="btn-jh waves-effect waves-light darken-4 blue"><i class="fa fa-save"></i> Asignar</a>
                        </div> 
                      </form>                     
               </div>
          ...
          <div class="container">
            <div class="section">
              <div class="row" >               
              <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                <p style="color: green">Estudiante solo puede tener activado una moto</p>
                <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: #1C2637; color: white; text-align: center; font-size: 15px; font-weight: bold;">MOTO ASIGNADO
                  </div>       
