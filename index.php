    ...
    <div class="col s12 z-depth-4 card-panel">
        <div class="row">
          <div class="input-field col s12 center"><br>
            ...
            <p class="center login-form-text"><b>SISTEMA DE PAGO DE PASAJES</b> </p>
            <?php
        ...
        <div class="row margin">
            <div class="input-field col s12">
              <i class="mdi-social-person-outline prefix" style="color: #005C50;"></i>
          ...
          <div class="row margin">
            <div class="input-field col s12">
              <i class="mdi-action-lock-outline prefix"  style="color: #005C50;"></i>
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <input type="submit" id="idLog" name="idLog" class="btn waves-effect cyan waves-light darken-4 col s12"  value="INGRESAR AL SISTEMA">
            </div>
          </div>
        </form>
    </div>
