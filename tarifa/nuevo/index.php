                    ...
                    <div class="formcontent">  
                      <div class="row" style="font-size: 18px; border-radius: 5px; border:#CBCBCB 1px solid;">
                       <div class="input-field col s12 m6 l6">
                          <input id="idtramo" name="idtramo" type="text" class="validate">
                          <label for="idtramo">Ingrese lugar</label>
                        </div>
                        <div class="input-field col s12 m6 l6">
                          <input id="idprecio" name="idprecio" type="number" class="validate">
                          <label for="idprecio">Ingrese costo de la tarifa</label>
                        </div>
                        ...
                        <a href="../" class="btn-jh waves-effect waves-light darken-4 red"><i class="fa fa-mail-reply-all"></i> Volver</a>
                          <a id="btnSave" class="btn-jh waves-effect waves-light darken-4 cyan"><i class="fa fa-save"></i> Guardar</a>
                        </div>                      
                      </div>
                </div>
              </form>
