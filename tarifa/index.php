      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div id="breadcrumbs-wrapper">
            <div class="container">
            <div class="row">
              <div class="col s12 m8 l8" style="background: white; text-align: center; color:#006458; font-size: 25px; border-radius: 5px; border: #CBCBCB 1px solid; font-weight: bold;">
                <?php echo $hd_titulo; ?>
              </div>
              ...
              <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                ...
                <table id="example2" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php
                    $contar=0;
                    foreach($tarifa->mostrarTodo("estado=1") as $f)
                    {                
                       $lblcode=ecUrl($f['idtarifa']);
                       $contar++;
                    ?>
                    <tr style="<?php echo $estilo ?>">
                      ...
                      <td>
                        ...
                        <!-- <button class="btn-jh waves-effect darken-4 red" onclick="elim('<?php //echo $f['idtarifa'] ?>');"><i class="fa fa-remov"></i> Eliminar</button> -->
