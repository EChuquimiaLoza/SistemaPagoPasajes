      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div id="breadcrumbs-wrapper">
            <div class="container">
              <div class="row">
              <div class="col s12 m12 l12" style="background: white; text-align: center; color:#006054; font-size: 25px; border-radius: 5px; border: #CBCBCB 1px solid; font-weight: bold;">
          ...
          <div class="container">
              <div class="row">
                <div class="col s12 m8 l12" style="text-align: center; color:#000000; border-radius: 5px; border: #CBCBCB 1px solid;">
                  ...
                  <form id="idform2" action="return false" onsubmit="return false" method="POST">
                    ...
                    <div class="col s12 m4 l3">
                      <p>
                        ...
                        <label for="ch-<?php echo $dmenu['idmenu']; ?>"><b style="color: #005852;"><?php echo $dmenu['nombre']; ?></b></label>
                      </p>
                      <?php
                    ...
                    ?>
                  </form> <div class="col s12" align="center">
                  <button id="btnSave" class="btn waves-effect waves-light darken-4 green"><i class="fa fa-save"></i> Guardar Cambios</button>
                </div>
                </div>
                <div class="col s12 m6 l6" style="background: white; text-align: center; color:#1C2637; border-radius: 5px; border: #CBCBCB 1px solid; ">
