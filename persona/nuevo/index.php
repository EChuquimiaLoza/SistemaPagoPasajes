...
<body>
          ...
          <!--breadcrumbs start-->
           ...
           <div class="row section">
                    ...
                    <ul class="tabs tab-demo-active z-depth-1 white">
                      <li class="tab col s3"><a class="green-text white waves-effect  waves-light active" href="#persona">REGISTRO Persona</a>
                      </li>
 ...
 <div class="col s12 m12 l1">
            ...
            <div id="persona" class="col s10  white lighten-4">
          ...
          <div class="divider">   </div>
                        ...
                        <div class="input-field col s12" align="right">
                         <!-- <a id="btnLimpiarp" class="btn waves-effect waves-light orange"><i class="fa fa-save"></i> Limpiar</a> -->
                          <a id="btnSavep" class="btn waves-effect waves-light green"><i class="fa fa-save"></i> Guardar y Siguiente</a>
                        </div> 
                    </div>
                </div>
              </form>
