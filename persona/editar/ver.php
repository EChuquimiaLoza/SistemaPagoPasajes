          ...
          <!--breadcrumbs start-->
           ...
           <div class="row section">
                    ...
                    <ul class="tabs tab-demo-active z-depth-1 white">
                      <li class="tab col s3"><a class="green-text waves-effect waves-light white active" href="#primera">DATOS PERSONA</a>
                      </li>
...
<form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
 ...
 <div class="col s12">.</div>
                    <div class="col s8 offset-s4 ">
                      <button id="btnSave" class="btn waves-effect waves-light green" >CONFIRMAR Y CONTINUAR REGISTRO   <i class="mdi-social-person-add"></i></button>
