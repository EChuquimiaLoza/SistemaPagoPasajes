...
<head>
    <?php
      $hd_titulo="Actualizar datos del registro";
        ...
        <section id="content">
          <!--breadcrumbs start-->
           ...
           <div class="row section">
                ...
                <div class="col s12 m12 l12 green-text">
          ...
          <div class="divider">   </div>
                        ...
                        <div class="input-field col s12" align="right">
                         <!--  <a id="btnLimpiarp" onclick="javascript:window.close();" class="btn waves-effect waves-light orange"><i class="fa fa-save"></i> Salir</a> -->
                          ...
                          <a id="btnSavep"  class="btn waves-effect waves-light darken-4 green"><i class="fa fa-save"></i> Guardar</a>
